...
export const SCOPE =
    "streaming user-read-private user-read-email user-follow-read user-read-recently-played user-library-read user-read-playback-position user-read-playback-state";
